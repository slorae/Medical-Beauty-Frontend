    ...
    return (
      <View className='container'>
        ...
        <View className='form-item-text'>
          <Navigator url='/packages/pages/auth/register/register' className='register'>注册账号</Navigator>
          <Navigator url='/packages/pages/auth/reset/reset' className='reset'>忘记密码</Navigator>
        </View>
        </View>
      </View>
    );
