...
class Index extends Component {
  ...
  selectCoupon = () => {
    Taro.navigateTo({
      url: '/packages/pages/ucenter/couponSelect/couponSelect'
    });
  };
            ...
            success: function(res) {
              ...
              if (grouponLinkId) {
                setTimeout(() => {
                  Taro.redirectTo({
                    url:
                      '/packages/pages/groupon/grouponDetail/grouponDetail?id=' +
                      grouponLinkId
                  });
                }, 1000);
              } else {
                Taro.redirectTo({
                  url: '/packages/pages/payResult/payResult?status=1&orderId=' + orderId
                });
              }
            },
            fail: function(res) {
              console.log('支付过程失败');
              Taro.redirectTo({
                url: '/packages/pages/payResult/payResult?status=0&orderId=' + orderId
              });
            },
      ...
      <View className='container'>
        ...
        <View className='message-box'>
          <Input
            ...
            onInput={this.bindMessageInput}
            placeholder='如需要，请输入留言'
            value={message}
          />
        </View>
