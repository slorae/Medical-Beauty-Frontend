...
class Index extends Component {
      ...
      success: function(res) {
        if (res.confirm) {
          ApiOrder.orderCancel({
            ...
            util.redirect('/packages/pages/ucenter/order/order');
          })
        }
      }
    });
  ...
  aftersaleOrder = () => {
    if(this.state.orderInfo.aftersaleStatus === 0){
      util.redirect('/packages/pages/ucenter/aftersale/aftersale?id=' + this.state.orderId );
    }
    else{
      util.redirect('/packages/pages/ucenter/aftersaleDetail/aftersaleDetail?id=' + this.state.orderId);
    }
  }
