...
class Index extends Component {
  ...
  addressAddOrUpdate(event) {
    ...
    if (prevPage.route == 'packages/pages/checkout/checkout') {
      try {
      ...
      if (addressId && addressId != 0) {
        ...
        Taro.navigateTo({
          url: '/packages/pages/ucenter/addressAdd/addressAdd?id=' + addressId
        })
      }

    } else {
      Taro.navigateTo({
        url: '/packages/pages/ucenter/addressAdd/addressAdd?id=' + event.currentTarget.dataset.addressId
      })
    }
  }
